...
.blue.azul2 {
  background-color: #015b9c !important;
}

.blue-text.text-azul2 {
...
.yellow.amarelo {
  background-color: #ffc946 !important;
}

.yellow-text.text-amarelo {
...
.tabs .tab a:focus, .tabs .tab a:focus.active {
  background-color: rgba(0,75,130, 0.2);
  outline: none;
}
...
textarea.materialize-textarea:focus:not([readonly]) {
  border-bottom: 1px solid #015b9c;
  box-shadow: 0 1px 0 0 #015b9c;
}
...
.datepicker-day-button:focus {
  background-color: rgba(1, 91, 156, 0.25);
}
...
.timepicker-tick:hover {
  background-color: rgba(38, 72, 166, 0.25);
}
